...
Gemini şunu dedi:
Atilla, paylaştığın metin Markdown formatında düzenlenmediği için GitHub üzerinde düz bir yazı gibi görünüp estetik durmuyor. Hocanın istediği profesyonel ve düzenli görünüme kavuşması için bu içeriği Markdown etiketleriyle (başlıklar, listeler ve kod blokları) yeniden düzenledim.

Aşağıdaki kod bloğunun tamamını kopyalayıp VS Code içerisindeki README.md dosyanın içine yapıştırabilirsin:
